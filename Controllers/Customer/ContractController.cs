        ...
        public ExecutionResult GetContractList()
        {
            ...
            return RunExceptionProof(() =>
            {
                var result = Repository<Contract>.GetSelectiveList(i => new ContractResult
                {
                    ...
                    StartDate = i.StartDate.HasValue ? PersianDateConverter.ToPersianDate(i.StartDate.Value) : "",
                    EndDate = i.EndDate.HasValue ? PersianDateConverter.ToPersianDate(i.EndDate.Value) : "",
